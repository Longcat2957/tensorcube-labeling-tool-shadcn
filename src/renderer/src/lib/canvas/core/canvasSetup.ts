 ...
 * 캔버스 이벤트 핸들러 등록
 */
export function registerCanvasEvents(fabricCanvas: Canvas, handlers: CanvasEventHandlers): void {
 ...
 * 캔버스 크기 조절
 */
export function resizeCanvas(fabricCanvas: Canvas, width: number, height: number): void {
